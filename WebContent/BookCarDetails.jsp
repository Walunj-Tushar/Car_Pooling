      ...
      <div class="content-wrapper">
                ...
                <div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-12">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;Car Booking Request</h1></i>
							</div>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.startdestination}" /></td>
        		<td><c:out value="${rows.enddestination}"/> </td>
        		<td><c:out value="${rows.date}" /></td>
        		<td><c:out value="${rows.time}" /></td>
        		<td><c:out value="${rows.cartype}" /></td>
        		<td><a target=blank href="https://www.google.co.in/maps?q=<c:out value="${rows.startdestination}"/> to <c:out value="${rows.enddestination}"/>"><c:out value="${rows.startdestination}"/> -to- <c:out value="${rows.enddestination}" /> </a></td>
        		 <td><c:choose>
        		...
        		<td><a href="BookingActive.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="green"> Accept</font></u></a><br>
        		 
<a href="BookingDective.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="red"> Discard</font></u></a>        	</tr>     
        </c:forEach>                             
                  <tbody>
