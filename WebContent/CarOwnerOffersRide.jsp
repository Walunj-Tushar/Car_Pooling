      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
                ...
                <div class="row d-flex justify-content-center">
						<div class="menu-content pb-30 col-lg-12">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;Offers Your Ride</h1></i>
							</div>
			...
			<div ng-controller="CountryCntrl" >
				...
				<input  class="form-control pull-right" id="amount1" name="amount1" value=''   placeholder="Amount (Rs)" ng-disabled="!city || !states || !amount1 " required="" />
                <br><br><br>
                 <input  class="form-control pull-right" id="amount" name="amount" value=''   placeholder="Enter Offer Amount (Rs)" ng-disabled="!city || !states " required="" type="text"/>
                    <br><br><br>
					</div>
        		</div>
                 ...
                 <div class="bootstrap-timepicker">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        &nbsp;&nbsp;End Time 
                        <input type="text" id="etime" name="etime" required="" placeholder="Select Your Reach Time " class="form-control timepicker"/>
                        
                      </div><!-- /.input group -->
                    </div><!-- /.form group -->
                  </div>
                  
                  <button class="primary-btn  mt-20" type="submit">Submit</button>
				<br><br>			
