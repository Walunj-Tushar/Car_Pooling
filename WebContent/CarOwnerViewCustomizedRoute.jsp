  ...
  <li class="dropdown user user-menu">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="CarOwnerViewCustomizedRoute.jsp?na=<%=email%>">
                <i class="fa fa-edit"></i> <span>View Customized Route</span>
              </a>
            </li>
            <li class="treeview">
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3><p><i class="fa fa-folder"></i>  Offers Ride</p></h3>
                ...
                <div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-12">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;Customized Route Car Booking Request</h1></i>
							</div>
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select *  from cutomizedroute        </sql:query>
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.firstpoint}" /></td>
        		<td><c:out value="${rows.secondpoint}"/> </td>
        		<td><c:out value="${rows.thirdpoint}" /></td>
        		<td><c:out value="${rows.fourthpoint}" /></td>
        		<td><c:out value="${rows.date}" /></td>
        		<td><c:out value="${rows.time}" /></td>
        		<td><a target=blank href="https://www.google.co.in/maps?q=<c:out value="${rows.firstpoint}"/> to <c:out value="${rows.fourthpoint}"/>"><c:out value="${rows.firstpoint}"/> -to- <c:out value="${rows.fourthpoint}"/> </a></td>
        		 <td><c:choose>
    				<c:when test="${rows.status=='1'}">
        			<font  color="#008710">	<i class="fa fa-lock"></i>	Booking Confirmed</font>	<br />
    				</c:when>    
    				<c:otherwise>
         			<font  color="red">	<i class="fa fa-unlock"></i>	Booking Request</font>
    				</c:otherwise>
					</c:choose>
				</td><!-- <i class="fa fa-lock"></i> <i class="fa fa-unlock"></i>-->
        		<td><a href="CustomizedRoteActive.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="green"> Accept</font></u></a><br>
        		 
<a href="CustomizedRoteDeactive.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="red"> Discard</font></u></a>        	</tr>     
        </c:forEach>                             
                  <tbody>
