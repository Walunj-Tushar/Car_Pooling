          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3>44</h3>
                  <p><i class="fa fa-folder"></i> Offer Rides</p>
                </div>
                <div class="icon">
		...
		<div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-edit">&nbsp;Booking Confirmation</h1></i>
							</div>
      		...
      		try
        		{
            		Class.forName("com.mysql.jdbc.Driver");
            		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/cabshearingsystem", "root", "root");           
            		String query="select * from bookcar  WHERE email='"+ email +"' and status=1 ";
            		Statement stmt=con.createStatement();
            		ResultSet rs=stmt.executeQuery(query);
			%>
			...
			%>
							<tr style="color:#000000 " >
								...
								<td> <%=rs.getString("enddestination") %> </td>
