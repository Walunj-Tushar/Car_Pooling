  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="index.jsp" class="logo"><b>Car</b>Pooling</a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <li><a id="Btn"  ><i class="fa fa-user" ></i> Car Owner Login</a></li>
            <li><a id="myBtn1"  ><i class="fa fa-user" ></i> Passenger Login</a></li>
             <li class="treeview">
			...
			<section class="banner-area relative" id="home">
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-8 col-md-20">
						...
						<div class="col-lg-8 form-group">
							<form action="CustomerLogin" method="post" name="UserLogin" id="UserLogin" />
							<fieldset>
			...
			<section class="banner-area relative" id="home">
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						...
						<div class="row">	
						<div class="col-lg-8 form-group">
							<form action="CarOwnerLogin" method="post" name="CustomerLogin" id="CustomerLogin" />
							<fieldset>
							<input name="email" placeholder="Enter Your Email (Eg. abc@gmail.com)" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input mb-20 form-control" required="" type="text">
							<input name="mno" placeholder="Enter Your Password (Eg.123456789)" pattern="[0-9]+[0-9]+[0-9]+[0-9]+[0-9]+[0-9]+[0-9]+[0-9]+[0-9]+[0-9]"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Your Password'" class="common-input mb-20 form-control" required="" type="password">
							</label>
							<div class="clearfix">
							<button class="primary-btn header-btn text-uppercase" type="submit">Login</span></button>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3>150</h3>
                  <p><i class="fa fa-car"></i> Register Your Car</p>
                </div>
                <div class="icon">
                  <i class="ion ion-android-car"></i>
                </div>
                <a href="RegisterCar.jsp" class="small-box-footer">Click Here For Car Registration<i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="BookCar.jsp" class="small-box-footer">Click Here For Book Car <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                  ...
                  <div class="box-body">
						...
						<div class="menu-content pb-30 col-lg-11">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-phone">&nbsp;Contact Us</h1></i>
							</div>
					...
					<form class="form-area mt-60" id="Form" action="ContactUs" method="post" class="contact-form text-right">
						...
						<div class="col-lg-6 form-group">
							...
							<input name="email" id="email" placeholder="Enter email address (Eg. abc@gmail.com)" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input mb-20 form-control" required="" type="email">

							<input name="subject" id="subject" placeholder="Enter your subject (Eg. abc)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your subject'" class="common-input mb-20 form-control" required="" type="text">
						</div>
						<div class="col-lg-6 form-group">
							<textarea class="common-textarea mt-10 form-control" name="message" placeholder="Enter Your Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
