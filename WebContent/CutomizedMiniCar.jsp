  ...
  <li class="dropdown user user-menu">
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
			...
			%>
			<input value='Mini Car' name="cartype" id="cartype"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Car Type'" class="common-input mb-20 form-control" required="" type="text">
