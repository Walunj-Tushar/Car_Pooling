              ...
              function CountryCntrl($scope) {
                $scope.countries = {
                		'Pune': {
                            ...
                            'Hadapsar,Pune': 85,
                    		'Katraj,Pune': 40,
                            'Pune Station,Pune':50,
                    'Viman Nagar,Pune':120,
                            'Kothrud,Pune': 60,
                    'Karve Nagar,Pune': 55,
                    ...
                    'Hinjavadi,Pune': 100
                        ...
                        'Nashik': {
                        	'Ambebahula,Nashik': 20 ,
                            ' Babhaleshwar,Nashik': 18,
                    		' Belatgavhan,Nashik': 15,
                            'Devargaon,Nashik': 17,
                            'Dahegaon,Nashik': 100,
                            ' Jalalpur,Nashik': 65,
                    		'Rahuri,Nashik': 30,
                            ' Vadgaon,Nashik':33,
                    ' Mohagaon,Nashik':80,
                            ' Pimplad Nasik,Nashik': 40,
                    'Talegaon Anjaneri,Nashik': 55,
  ...
  <li class="dropdown user user-menu">
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
                  ...
                  <div class="row d-flex justify-content-center">
						<div class="menu-content pb-30 col-lg-12">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;&nbsp;Select Your Customized Route</h1></i>
							</div>
			      <form class="form-area mt-20" id="myForm" action="CustomizedRoute" method="post" >
			...
			%>
			<input value='Mini-Micro' name="cartype" id="cartype"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Car Type'" class="common-input mb-20 form-control" required="" type="text">
			...
			<div ng-controller="CountryCntrl" >
    		    <div>
					...
					<select name="firstpoint" id="firstpoint" placeholder="Enter Start Destination (Eg.Swargate,pune)" ng-disabled="!states" ng-model="cities" ng-options="state for (state,city) in states" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your First name'" class="common-input mb-20 form-control" required="" type="text">
					<option value=''>Select Your Pick Point</option>
                	</select>
                	</select>
					<select name="secondpoint" id="secondpoint" placeholder="Enter Start Destination (Eg.Swargate,pune)" ng-disabled="!cities" ng-model="cities1" ng-options="state for (state,city) in states" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your First name'" class="common-input mb-20 form-control" required="" type="text">
					<option value=''>Select Your Second Point</option>
                	</select>
                	</select>
					<select name="thirdpoint" id="thirdpoint" placeholder="Enter Start Destination (Eg.Swargate,pune)" ng-disabled="!cities1" ng-model="cities2" ng-options="state for (state,city) in states" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your First name'" class="common-input mb-20 form-control" required="" type="text">
					<option value=''>Select Your Third Point</option>
                	</select>
					<select name="fourthpoint" id="fourthpoint" placeholder="Enter Start Destination (Eg.Swargate,pune)" ng-disabled="!cities2" ng-model="cities3" ng-options="state for (state,city) in states" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your First name'" class="common-input mb-20 form-control" required="" type="text">
					<option value=''>Select Your Drop Point</option>
                	</select>
					 <input  class="form-control pull-right" id="amount" name="amount" value='{{cities3+cities2+cities1}}'   placeholder="Amount (Rs)" ng-disabled="!cities2 || !states || !amount" required=""/>
                    <br><br><br>
							</div>
        		</div>
