               		...
               		<div class="row d-flex justify-content-center">
						<div class="menu-content pb-30 col-lg-11">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-edit">&nbsp;ADD PLANS</h1></i>
							</div>
								<form class="form-area mt-60" id="Form" action="HolidaysPlan" method="post" class="contact-form text-right">
								<div class="row">	
						<div class="col-lg-12 form-group">
							
							<input name="pname" id="pname" placeholder="Enter Plan Header " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Plan Header'" class="common-input mb-20 form-control" required="" type="text">
						    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="date" class="form-control pull-right" id="sdate" name="sdate" placeholder="Select From Date" required/>
                    </div><!-- /.input group -->
                    <br>
                    <div class="input-group">
                      <div class="input-group-addon">
                      ...
                      <input type="date" class="form-control pull-right" id="edate" name="edate" placeholder="Select To Date" required/>
                    </div><!-- /.input group -->
                    <br>
                   	<input name="price" id="price" placeholder="Enter price " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Budget Of Plan'" class="common-input mb-20 form-control" required="" type="text">
			      	<textarea class="common-textarea mt-10 form-control" name="aboutplan" placeholder="Enter About Plan Details" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
							<button class="primary-btn mt-20" type="submit">Add Plan<span class="lnr lnr-arrow-right"></span></button>
