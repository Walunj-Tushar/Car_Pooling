              ...
              function CountryCntrl($scope) {
                $scope.countries = {
                		'Pune': {
                            ...
                            'Hadapsar,Pune': 130,
                    		'Katraj,Pune': 75,
                            'Pune Station,Pune':85,
                    'Viman Nagar,Pune':225,
                            'Kothrud,Pune': 133,
                    'Karve Nagar,Pune': 170,
  ...
  <li class="dropdown user user-menu">
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
			...
			%>
			<input value='MiniMicro' name="cartype" id="cartype"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Car Type'" class="common-input mb-20 form-control" required="" type="text">
