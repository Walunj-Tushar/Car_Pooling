		  			...
		  			<div class="container">
				  		<div class="row">
				  			<div class="col-lg-6 col-sm-8 col-4 header-top-left no-padding">
				  				<ul>
				  					<li><a href="tel:+880 1234 654 953"><span class="lnr lnr-phone-handset"></span><span class="text">+880 1234 654 953</span></a></li>
				  			...
				  			<div class="col-lg-6 col-sm-4 col-8 header-top-right no-padding">
				  				<a class="text-uppercase top-head-btn" href="#">Purchase Hosting</a>
				  			</div>
				  		</div>			  					
		  			</div>
				</div>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-8 col-md-12">
							...
							<a href="#" class="primary-btn header-btn text-uppercase">Explore Our Features</a>
						</div>												
					</div>
				</div>
			</section>
					...
					<div class="details-section">
						<div class="row align-items-center">
							...
							<div class="col-lg-9 detials-right">
								<p>
									inappropriate behavior is often laughed off as â€œboys will be boys,â€ women face higher conduct standards especially in the workplace. Thatâ€™s why itâ€™s crucial that, as women, our behavior on the job is beyond reproach. inappropriate behavior is often laughed off as â€œboys will be boys,â€
								</p>
							</div>
						</div>						
					</div>
						...
						<div class="col-lg-4">
							<div class="single-price">
								...
								<div class="bottom-sec">
									<p>
										â€œFew would argue that, despite the advancements
									</p>
								</div>
								<div class="end-sec">
									<ul>
				...
				<div class="container">
					<div class="row justify-content-start">
						<div class="col-lg-5">
							...
							<p class="pt-20 pb-20">
								inappropriate behavior is often laughed off as â€œboys will be boys,â€ women face higher conduct standards â€“ especially in the workplace. Thatâ€™s why itâ€™s crucial that, as women.
							</p>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="faq-content col-lg-9 col-md-9">
							<div class="single-faq">
								...
								<p>
									â€œFew would argue that, despite the advancements of feminism over the past three decades, women still face a double standard when it comes to their behavior. While menâ€™s borderline-inappropriate behavior.
								</p>
							</div>
							<div class="single-faq">
								<h2>
