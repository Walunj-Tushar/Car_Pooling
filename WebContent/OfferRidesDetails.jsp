      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
              <div class="box box-primary">
				...
				<h1 class="mb-10"><i class="fa fa-car">&nbsp;Offer Rides Details</h1></i>
							</div>
							<form action="#" method="post">
    		<%@  page  import="java.sql.*"  %>
			<%
      		...
      		try
        		{
            		Class.forName("com.mysql.jdbc.Driver");
            		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/cabshearingsystem", "root", "root");           
            		String query="select * from offersride where email='"+email+"' ";
            		Statement stmt=con.createStatement();
            		ResultSet rs=stmt.executeQuery(query);
			%>
			...
			%>
				...
				<td><button><a href="DeleteUserRecord.jsp?id=<%=id %>" style="color:red;"><i class="fa fa-trash-o"></i> Delete</a></button> </td>
							</tr>
			<%
             			}
			%> 
