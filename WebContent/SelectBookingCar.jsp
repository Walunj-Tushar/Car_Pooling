      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
              ...
              <div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;&nbsp;Select Car For Booking </h1></i>
							</div>
                <div class="box-body">
                <br>
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              <a href="MicroCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp;&nbsp; Micro Car
              </a>
             </li>
             <br>
                <li class="treeview">
              <a href="MiniCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp;&nbsp; Mini Car
              </a>
             </li>
             <br>
                <li class="treeview">
              <a href="SharingCar.jsp?na=<%=email%>" align="">
             ...
             <li class="treeview">
              <a href="MiniMicroCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp; MiniMicro Car
              </a>
             </li>
            <br>
             <li class="treeview">
              <a href="SelectCustomizedCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp; Customized Route
              </a>
             </li>
            <br>
             </ul>
