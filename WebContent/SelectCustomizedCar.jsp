  ...
  <li class="dropdown user user-menu">
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              <a href="CutomizedMicroCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp;&nbsp; Micro Car
              </a>
             </li>
             <br>
                <li class="treeview">
              <a href="CutomizedMiniCar.jsp?na=<%=email%>" align="">
                <i class="fa fa-car"></i>&nbsp;&nbsp; Mini Car
              </a>
             </li>
             <br>
                <li class="treeview">
              <a href="CutomizedSharingCar.jsp?na=<%=email%>" align="">
             ...
             <li class="treeview">
              <a href="CutomizedMiniMicroCar.jsp?na=<%=email%>" align="">
