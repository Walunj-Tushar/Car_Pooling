              ...
              function CountryCntrl($scope) {
                $scope.countries = {
                		'Pune': {
                            ...
                            'Hadapsar,Pune': 80,
                    		'Katraj,Pune': 20,
                            'Pune Station,Pune':30,
                    'Viman Nagar,Pune':150,
                            'Kothrud,Pune': 30,
                    'Karve Nagar,Pune': 35,
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-14">
			...
			<div ng-controller="CountryCntrl" >
    		    <div>
    				<select name="startdestination" id="startdestination" placeholder="Enter Start Destination (Eg.Swargate,pune)" ng-model="states" ng-options="country for (country, states) in countries" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your First name'" class="common-input mb-20 form-control" required="" type="text">
