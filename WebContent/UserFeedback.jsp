		...
		<div class="col-md-16">
                       ...
                       <div class="box-body">
						...
						<div class="menu-content pb-30 col-lg-11">
							<div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-edit">&nbsp;Feedback</h1></i>
							</div>
															
					<form class="form-area mt-60" id="Form" action="UserFeedback" method="post" class="contact-form text-right">
								<div class="row">	
			...
			<%
            		...
            		while(rs.next()) 
             			{
              %>
							<input name="fname" id="fname" value="<%=rs.getString("fname") %>"  placeholder="Enter your name (Eg. Tushar )" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mb-20 form-control" required="" type="text">
						    <input name="lname" id="lname" value="<%=rs.getString("lname") %>"  placeholder="Enter your name (Eg.  Walunj)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mb-20 form-control" required="" type="text">
						    <input name="mno" id="mno" value="<%=rs.getString("mno") %>"  placeholder="Enter Mobile Number (Eg.1234567890)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your Mobile Number'" class="common-input mb-20 form-control" required="" type="text">
			...
			%>
							...
							<input name="subject" id="subject" placeholder="Enter Subject (Eg. abc)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your subject'" class="common-input mb-20 form-control" required="" type="text">
		
							<textarea class="common-textarea mt-10 form-control" name="message" placeholder="Enter Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
							<button class="primary-btn mt-10" type="submit">Send</button>
