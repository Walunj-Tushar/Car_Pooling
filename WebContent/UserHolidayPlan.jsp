		...
		<div class="col-md-14">
              <div class="box box-primary">
                ...
                <div class="title text-center">
								<h1 class="mb-10"><i class="fa fa-edit">&nbsp;Holidays Plans</h1></i>
							</div>
		...
		<div class="container">
      		...
      		try
        		{
            		Class.forName("com.mysql.jdbc.Driver");
            		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/cabshearingsystem", "root", "root");           
            		String query="select * from holidayplan";
            		Statement stmt=con.createStatement();
            		ResultSet rs=stmt.executeQuery(query);
			%>
                   <%
			...
			%>
							<div class="single-price">
								<div class="col-lg-11">
									<div class="col-lg-11">
		    <h1>@<%=rs.getString("price") %>/-Rs. ONLY</h1>
										<p><h2><%=rs.getString("pname") %> </h2>
        								</p>
								...
								<div class="bottom-sec">
									<p>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										From : <%=rs.getString("sdate") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										To : <%=rs.getString("edate") %><br>
