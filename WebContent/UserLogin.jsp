...
<button class="width-35 pull-left btn btn-sm btn-primary" id="myBtn" ><h4>Login</button>
<!-- The Modal -->
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						...
						<div class="col-lg-8 form-group">
							<form  action="CustomerLogin" method="post" name="CustomerLogin" id="CustomerLogin" />
							<fieldset>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
             ...
             <li><a href="UserLogin.jsp"  ><i class="fa fa-user" ></i> User Login</a></li>
             <li><a href="CarOwnerLogin.jsp"  ><i class="fa fa-user" ></i> Car Owner Login</a></li>
             <li class="treeview">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box-header">
                  ...
                  <div class="box-body">
					<h3>
<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Car pooling system reduces the misery of travelers and make them find cars in short period of time.
<br><br>
<i class="fa fa-circle-o"></i>&nbsp;&nbsp;	 Car pooling, is an application of finding car in which drivers who are traveling to work alone can ask for fellow passengers through our application. 
<br><br>
	<i class="fa fa-circle-o"></i>&nbsp;&nbsp;For those who use public-transport system to go to work daily can use this application to find drivers who are traveling to the same destination in a short path.
<br><br>
	<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Car pooling system is an effort to reduce consumption of fuel, our most important non-renewable resource and traffic congestion on roads by encouraging people to use cars haring.
