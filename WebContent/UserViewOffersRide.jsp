  ...
  <li class="dropdown user user-menu">
      ...
      <div class="content-wrapper">
              ...
              <div class="box box-primary">
                ...
                <!-- Start service Area -->
					<div class="row d-flex justify-content-center">
								...
								<h1 class="mb-10"><i class="fa fa-car">&nbsp;&nbsp;Offers Ride</h1></i>
							</div>
												</div>
					<div class="row">
        ...
        <sql:query dataSource="${dbsource}" var="result">
        		Select *  from offersride        </sql:query>
        	...
        	<tr  style="color: black">
        		...
        		<td><c:out value="${rows.startpoint}" /></td>
        		<td><c:out value="${rows.endpoint}" /></td>
        		...
        		<td><a target=blank href="https://www.google.co.in/maps?q=<c:out value="${rows.startpoint}" /> to <c:out value="${rows.endpoint}"/>"><c:out value="${rows.startpoint}" /> -to-<c:out value="${rows.endpoint}" /> </a></td>
        		<td><c:out value="${rows.amount1}" /></td>
        		<td><c:out value="${rows.amount}" /></td>
        		 <td><c:choose>
    				<c:when test="${rows.status=='1'}">
        			<font  color="#008710">	Booking Confirmed</font>	<br />
    				</c:when>    
    				<c:otherwise>
         			<font  color="red">		Booking Pending</font>
    				</c:otherwise>
					</c:choose>
				</td>
        		<td><a href="OfferRideActive.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="green"> Confirm Booking</font></u></a><br>
        		 
<a href="OfferRideDeactive.jsp?id=<c:out value="${rows.id}"/>"><u><font  color="red">Cancel Booking</font></u></a>        	</tr>     
        </c:forEach>                             
                  <tbody>
